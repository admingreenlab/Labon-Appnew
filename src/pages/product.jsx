...
function Product() {
    ...
    const fetchProductData = async () => {
        ...
        try {
            ...
            setdia(response?.data?.diamondpcs?.pcs)
            setError(null);
        } catch (error) {
    ...
    const pricereturn = () => {
        const curitem = categoryDetails?.find((cat) => {
            return cat._id === id
        })
    ...
    return (
        <>
            ...
            <IonContent color="primary" style={{ paddingBottom: '80x', marginBottom: '100px', marginTop: '10px' }}>
                ...
                <div className='main-catagory' style={{ marginBottom: '122px' }}>
                    <IonGrid>
                        <IonRow>
                                    ...
                                    <IonCol>
                                        <div className='productreduiom' >
                                            ...
                                            <div className="product-detail">
                                                ...
                                                >
                                                    <span className="d-block">In Stock Specs</span>
                                                    <span
                                                        className="d-block "
                                                        style={{ fontSize: "15px" }}
                                                    >
                                                ...
                                                <div>
                                                    ...
                                                    {itemsize ? (
                                                        <div className='stock-specstp' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                    ...
                                                    <div className='stock-specstp' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                        <h6 style={{ margin: '0' }}>Metal Color</h6>
                                                        <span>{metalcolor}</span>
                                                    </div>
                                                    <div className='stock-specstp' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                        <h6 style={{ margin: '0' }}>Metal</h6>
                                                        <span>{metal}</span>
                                                    </div>
                                                    <div className='stock-specstp' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                        <h6 style={{ margin: '0' }}>Number of Diamonds</h6>
                                                        <span>{diapcs} Pcs</span>
                                                    </div>
                                                    {/* {
                                                    ...
                                                    <div className="accordion">
                                                        <div className="accordion-item" style={{ marginBottom: "0" }}>
                                                            <h2 className="accordion-header">
                                                                ...
                                                                >
                                                                    Diamond Details
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#ffe4c4" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                                                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708" />
                                                                    </svg>
                                                                </button>

                                                            </h2>
                                                            {productDetails.diamonds && productDetails.diamonds.length > 0 && (
                                                                <div
                                                                    className={`accordion-collapse collapse ${isOpen ? 'show' : ''}`}
                                                                    style={{}}>
                                                                    <div className="p-0 accordion-body" style={{ padding: "7px" }}>
                                                                        <table className="table">
                                                                            ...
                                                                            <tbody>
                                                                                {productDetails.diamonds.map((diamond, index) => (
                                        ...
                                        <div className='productreduio'>
                                            ...
                                            <div className='diamondcolmin' style={{ marginBottom: '10px' }}>
                                                ...
                                                <IonRadioGroup value={selectedQuality} onIonChange={(e) => setSelectedQuality(e.detail.value)} style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '10px', margin: '0' }}>
