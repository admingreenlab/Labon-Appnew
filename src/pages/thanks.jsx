        ...
        <IonHeader>
            ...
            <IonRow>
                ...
                <div style={{textAlign:'center' , marginTop:'100px'}}>
                    ...
                    />
                    <h4>Thank you for </h4>
                    <p style={{fontSize:'13px', maxWidth:'380px', margin:'auto'}}>
                    ...
                    <ion-router-link href='/home' className="badge button --shutter --up d-block"
                        style={{ width: "fit-content", margin: "auto" , padding:'10px', color:'#fff',background:'#4c3226', display:'block',marginTop:"20px", textTransform:'uppercase' }}>
                        Return to Homepage
                    </ion-router-link>
            </div>
                </IonCol>
